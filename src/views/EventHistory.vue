          ...
          <v-container>
            <v-row>
              <v-col cols="12" sm="3" md="3">
                <h3 class="ml-md-8 mt-n2" :style="{ color: 'green' }">
                  EVENTS HISTORY
                </h3>
              </v-col>
              ...
              <v-col class="mt-n4" cols="12" sm="6" md="6">
                <input
                  v-model="search"
                  class="textbox ml-n1 ml-md-n8 ml-lg-n16"
   ...
   -->
                      <button>
                        <v-icon
                          class="mt-n2"
                          color="primary"
                          @click="handleRowEventHistoryClick(item)"
                          large
                          >mdi-printer</v-icon
                        >
                      </button>
                      <button>
                        <v-icon
                          class="mt-n2"
                          color="green"
                          @click="handleRowEventHistoryClick2(item)"
                          large
...
export default {
  ...
  methods: {
    ...
    // NonattendancePrint
    handleRowEventHistoryClick2(item) {
      console.log("users=", item.columns.ID);
      localStorage.setItem("ID", item.columns.ID);
      this.$router.push({
        name: "EventDetails2",
